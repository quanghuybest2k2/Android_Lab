package vn.dlu.a2015597_doanquanghuy;
...
public class MainActivity extends AppCompatActivity {
    ...
    {{add(new Food(1,"Chả Bò",120000,"Đồng",R.drawable.chabo));
        add(new Food(2,"Chả Lụa",120000,"Đồng",R.drawable.chalua));
        add(new Food(3,"Phở Xào",120000,"Đồng",R.drawable.phoxao));
